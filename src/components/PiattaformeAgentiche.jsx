      ...
      <section className="aga-cta">
        <div className="aga-cta-inner">
          ...
          <div className="aga-cta-btns">
            <a href="https://mail.google.com/mail/?view=cm&to=info@blumentis.ai&su=Richiesta Demo SonIA OlivIA&body=Ciao,%20ti%20contatto%20per..." target="_blank" className="aga-cta-primary">{t('agentiche.cta.button')}</a>
